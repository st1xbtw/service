...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-page="chat">Чат</a>
                    </li>
                </ul>
                        ...
                        <div class="step-content active" data-step="1">
                            <div class="glass-card p-4 mb-4">
                                ...
                                <div class="service-options-grid">
                                    <div class="service-option-card active" data-service="video">
                                        ...
                                        <ul class="option-features">
                                            <li>Промо-ролики - 500 рублей</li>
                                            <li>Интро/Аутро - 350 рублей</li>
                                            <li>Футажи - 500 рублей</li>
                                        </ul>
                                    </div>
                                    <div class="service-option-card" data-service="images">
                                        <div class="service-icon">
                                        ...
                                        <p>от 100 ₽</p>
                                        <ul class="option-features">
                                            <li>Баннер - 200 рублей</li>
                                            <li>Пост для соц. сетей - 100 рублей</li>
                                            <li>Пикчи - 150 рублей</li>
                                        </ul>
                                    </div>
                                    <div class="service-option-card" data-service="avatar">
                                        <div class="service-icon">
                                            <i class="fas fa-user-circle"></i>
                                        </div>
                                        ...
                                        <p>от 100 ₽</p>
                                        <ul class="option-features">
                                            <li>Аниме - 100 рублей</li>
                                            <li>Фильм - 150 рублей</li>
                                            <li>Сложная работа - 250 рублей</li>
                                        </ul>
                                    </div>
                                    <div class="service-option-card" data-service="ads">
                                        <div class="service-icon">
                                            <i class="fas fa-ad"></i>
                                        </div>
                                        ...
                                        <p>от 350 ₽</p>
                                        <ul class="option-features">
                                            <li>1 день - 350 рублей</li>
                                            <li>3 дня - 600 рублей</li>
                                            <li>7 дней - 1200 рублей</li>
                                            <li>14 дней - 2000 рублей</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="glass-card p-4 mb-4">
                                ...
                                <div class="customization-options">
                                    ...
                                    <div class="customization-card">
                                        ...
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" id="option-fast">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option-support">
                            ...
                            <div class="glass-card p-4 mb-4">
                                ...
                                <div class="order-summary-preview">
                                    ...
                                    <div class="summary-item">
                                        ...
                                        <span id="summary-deadline">7 дней</span>
                                    </div>
                                    <div class="summary-item">
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8">
                        ...
                        <div class="galaxy-badge">
                            <i class="fas fa-crown me-2"></i>Эксклюзивный доступ к премиум функциям
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="chat" class="page page-transition">
        <div class="container py-5">
            <h1 class="text-center mb-5">Умный AI Чат</h1>
                ...
                <div class="col-lg-10">
                    <div class="glass-card p-4">
                        ...
                        <div class="quick-replies" id="quick-replies">
                            <div class="quick-reply" data-message="Расскажи о себе">О себе</div>
                            <div class="quick-reply" data-message="Какие услуги ты предоставляешь?">Услуги</div>
                            <div class="quick-reply" data-message="Как купить звёзды для Telegram?">Покупка звезд</div>
                            <div class="quick-reply" data-message="Сколько стоит реклама?">Стоимость рекламы</div>
                            <div class="quick-reply" data-message="Как связаться с поддержкой?">Поддержка</div>
                            <div class="quick-reply" data-message="Расскажи что-нибудь интересное">Интересный факт</div>
                        </div>
                        <form id="chat-form" class="mt-3">
                            <div class="input-group">
                                <input type="text" class="form-control" id="chat-message" placeholder="Задайте любой вопрос умному AI..." required>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-5">
                        <div class="glass-card p-4 login-card">
                            ...
                            <form id="login-form">
                                ...
                                <div class="text-center">
                                    <a href="#" data-page="register">Нет аккаунта? Зарегистрироваться</a>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="glass-card p-4 login-card">
                            ...
                            <form id="register-form">
                                ...
                                <div class="mb-3 form-check">
                                    ...
                                    <label class="form-check-label" for="agree-terms">Я согласен с условиями использования</label>
                                </div>
    ...
    <!-- УЛУЧШЕННЫЙ ЛИЧНЫЙ КАБИНЕТ С ЦЕНТРИРОВАННОЙ ЗАГРУЗКОЙ АВАТАРКИ -->
    <div id="dashboard" class="page page-transition">
        <div class="container py-5">
            <h1 class="text-center mb-5">Личный кабинет</h1>
            
            <div class="asymmetric-profile">
                <div class="profile-main">
                    <div class="profile-card-modern">
                        <!-- ЦЕНТРИРОВАННАЯ ЗАГРУЗКА АВАТАРА -->
                        <div class="avatar-upload-center">
                            <div class="avatar-preview-container">
                                <img id="avatar-preview-center" class="avatar-preview-center" alt="Предпросмотр аватара">
                                <div class="avatar-edit">
                                    <i class="fas fa-camera"></i>
                                    <input type="file" id="avatar-upload-input-center" accept=".jpg,.jpeg,.png,.gif">
                                </div>
                            </div>
                            
                            <div class="avatar-upload-area" id="avatar-upload-area-center">
                                <div class="avatar-upload-icon">
                                    <i class="fas fa-cloud-upload-alt"></i>
                                </div>
                                <h5>Загрузить аватар</h5>
                                <p class="avatar-upload-info">Перетащите изображение сюда или нажмите для выбора</p>
                                <p class="avatar-upload-info">Поддерживаются: JPG, PNG, GIF (макс. 5MB)</p>
                            </div>
                        </div>
                        
                        <div class="profile-info-modern">
                            <div class="profile-name-modern" id="dashboard-username-modern">Пользователь</div>
                            <div class="profile-email-modern" id="dashboard-email-modern">user@example.com</div>
                            <div class="profile-status-modern" id="user-status-modern">● онлайн</div>
                            <div class="mt-2" id="registration-date">Зарегистрирован: <span id="registration-date-value">01.01.2023</span></div>
                        </div>
                        
                        <div class="profile-stats-modern">
                            <div class="profile-stat-item">
                                <div class="profile-stat-number" id="user-orders-count-modern">0</div>
                                <div class="profile-stat-label">Заказов</div>
                            </div>
                            <div class="profile-stat-item">
                                <div class="profile-stat-number" id="user-activity-percent-modern">0%</div>
                                <div class="profile-stat-label">Активность</div>
                            </div>
                            <div class="profile-stat-item">
                                <div class="profile-stat-number" id="user-reviews-count-modern">0</div>
                        ...
                        <div class="profile-actions-modern">
                            <button class="btn btn-primary w-100" id="save-profile-btn-modern">
                    ...
                    <div class="profile-widget">
                        <h4 class="mb-4">Визуализация статистики</h4>
                        <div class="stat-visual">
                            <span>Заказы</span>
                            <div class="stat-bar">
                                <div class="stat-fill" id="orders-visual-bar"></div>
                            </div>
                            <span id="orders-visual-percent">0%</span>
                        </div>
                        <div class="stat-visual">
                            <span>Активность</span>
                            <div class="stat-bar">
                                <div class="stat-fill" id="activity-visual-bar"></div>
                            </div>
                            <span id="activity-visual-percent">0%</span>
                        </div>
                        <div class="stat-visual">
                            <span>Отзывы</span>
                            <div class="stat-bar">
                                <div class="stat-fill" id="reviews-visual-bar"></div>
                            </div>
                            <span id="reviews-visual-percent">0%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="profile-sidebar">
                    <div class="profile-widget">
                        ...
                        <div class="order-history" id="orders-history">
                            <!-- История заказов будет загружена через JavaScript -->
                        </div>
                    </div>
                    
                    <div class="profile-widget">
                        <h4 class="mb-4">Карта активности</h4>
                        <div class="activity-map">
                            <div class="activity-dots">
                                <div class="activity-dot" style="top: 20%; left: 30%"></div>
                                <div class="activity-dot" style="top: 40%; left: 60%"></div>
                                <div class="activity-dot" style="top: 70%; left: 20%"></div>
                                <div class="activity-dot" style="top: 50%; left: 80%"></div>
                                <div class="activity-dot" style="top: 80%; left: 50%"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        const setupOrderConstructor = () => {
            ...
            const budgetSlider = document.getElementById('order-budget');
            ...
            const updateOrderPreview = () => {
                ...
                document.getElementById('summary-deadline').textContent = `${document.getElementById('order-deadline')?.value || '7'} дней`;
            ...
            const calculateOrderPrice = () => {
                ...
                switch(selectedService) {
                    case 'video': price = 350; break;
                    case 'images': price = 100; break;
                    case 'avatar': price = 100; break;
                    case 'ads': price = 350; break;
                }
            ...
            const updateOrderDetails = () => {
                        ...
                        orderDetailsForm.innerHTML += `
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="video-type" required>
                                    ...
                                    <option value="promo" data-price="500">Промо-ролик (500 руб.)</option>
                                    <option value="intro" data-price="350">Интро/Аутро (350 руб.)</option>
                                    <option value="footage" data-price="500">Футажи (500 руб.)</option>
                                </select>
                            </div>
                            <div class="mb-3">
                        ...
                        orderDetailsForm.innerHTML += `
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="image-type" required>
                                    ...
                                    <option value="banner" data-price="200">Баннер (200 руб.)</option>
                                    <option value="post" data-price="100">Пост для соц. сетей (100 руб.)</option>
                                    <option value="pic" data-price="150">Пикчи (150 руб.)</option>
                                </select>
                            </div>
                            <div class="mb-3">
                        ...
                        orderDetailsForm.innerHTML += `
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="avatar-style" required>
                                    ...
                                    <option value="anime" data-price="100">Аниме (100 руб.)</option>
                                    <option value="movie" data-price="150">Фильм (150 руб.)</option>
                                    <option value="complex" data-price="250">Сложная работа (250 руб.)</option>
                                </select>
                            </div>
                            <div class="mb-3">
                        ...
                        orderDetailsForm.innerHTML += `
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="ad-duration" required>
                                    ...
                                    <option value="1" data-price="350">1 день (350 руб.)</option>
                                    <option value="3" data-price="600">3 дня (600 руб.)</option>
                                    <option value="7" data-price="1200">7 дней (1200 руб.)</option>
                                    <option value="14" data-price="2000">14 дней (2000 руб.)</option>
                                </select>
                            </div>
                            <div class="mb-3">
                ...
                // Добавляем поле срока выполнения
                orderDetailsForm.innerHTML += `
                    <div class="mb-3">
                        <label for="order-deadline" class="form-label">Срок выполнения</label>
                        <select class="form-select" id="order-deadline" required>
            ...
            if (submitButton) {
                submitButton.addEventListener('click', function() {
                    ...
                    message += `Срок: ${orderData.deadline} дней\n`;
        ...
        const updateDashboard = () => {
            const currentUser = JSON.parse(localStorage.getItem('currentUser'));
            if (currentUser) {
                document.getElementById('dashboard-username-modern').textContent = currentUser.name;
                document.getElementById('dashboard-email-modern').textContent = currentUser.email;
                
                const avatarElement = document.getElementById('avatar-preview-center');
                if (currentUser.avatar) {
                    avatarElement.src = currentUser.avatar;
                    avatarElement.style.display = 'block';
                    document.getElementById('avatar-upload-area-center').style.display = 'none';
                } else {

                }
                
                document.getElementById('user-status-modern').textContent = `● ${currentUser.onlineStatus === 'online' ? 'онлайн' : 'офлайн'}`;
                document.getElementById('user-status-modern').className = currentUser.onlineStatus === 'online' ? 'status-online' : 'status-offline';
                ...
                if (currentUser.registrationDate) {
                    ...
                    document.getElementById('registration-date-value').textContent = formattedDate;
                }
        ...
        const updateUserStats = (userId) => {
            ...
            const userReviews = reviews.filter(review => review.name === users.find(u => u.id === userId)?.name);
            const completedOrders = userOrders.filter(order => order.status === 'completed').length;
            
            // Вычисляем проценты для визуализации
            const ordersPercent = userOrders.length > 0 ? Math.min(100, (userOrders.length / 10) * 100) : 0; // 10 заказов = 100%
            const activityPercent = userOrders.length > 0 ? Math.round((completedOrders / userOrders.length) * 100) : 0;
            const reviewsPercent = userReviews.length > 0 ? Math.min(100, (userReviews.length / 5) * 100) : 0; // 5 отзывов = 100%

            // Обновляем статистику
            document.getElementById('user-orders-count-modern').textContent = userOrders.length;
            document.getElementById('user-activity-percent-modern').textContent = `${activityPercent}%`;
            document.getElementById('user-reviews-count-modern').textContent = userReviews.length;
            
            // Устанавливаем проценты в визуализацию
            document.getElementById('orders-visual-bar').style.width = `${ordersPercent}%`;
            document.getElementById('orders-visual-percent').textContent = `${ordersPercent}%`;
            document.getElementById('activity-visual-bar').style.width = `${activityPercent}%`;
            document.getElementById('activity-visual-percent').textContent = `${activityPercent}%`;
            document.getElementById('reviews-visual-bar').style.width = `${reviewsPercent}%`;
            document.getElementById('reviews-visual-percent').textContent = `${reviewsPercent}%`;
        };
        ...
        const loadOrderHistory = (userId) => {
            ...
            if (userOrders.length === 0) {
                ordersHistory.innerHTML = '<p class="text-center text-muted">У вас пока нет заказов</p>';
                return;
            }
            ...
            userOrders.forEach(order => {
                ...
                if (order.status === 'completed' && !order.hasReview) {
                    reviewButton = `<button class="btn btn-sm btn-accent leave-review-btn" data-order-id="${order.id}">Оставить отзыв</button>`;
                }
                
                orderElement.innerHTML = `
                        <h5>Заказ #${order.id}</h5>
                        <span class="badge ${order.status === 'completed' ? 'bg-success' : 'bg-warning'}">${order.status === 'completed' ? 'Выполнен' : 'В обработке'}</span>
                    </div>
                    <p><strong>Тип:</strong> ${getOrderTypeName(order.type)}</p>
                    <p><strong>Дата:</strong> ${order.date}</p>
                    <p><strong>Стоимость:</strong> ${order.price || 'Не указана'} руб.</p>
                    ${reviewButton}
                `;
        ...
        // Загрузка сообщений чата с УМНЫМ AI
        const loadChatMessages = () => {
            ...
            if (messages.length === 0) {
                chatContainer.innerHTML = '<p class="text-center text-muted">Пока нет сообщений</p>';
                return;
            }
            
            messages.forEach(message => {
                const messageElement = document.createElement('div');
                if (message.isUltraAI) {
                    messageElement.className = 'ultra-ai-message';
                    ...
                    messageElement.className = 'ai-bot-message';
                    messageElement.innerHTML = `
                        <div class="sender">${message.username}</div>
                        <div class="text">${message.text}</div>
                        <div class="time">${message.time}</div>
        ...
        const setupAuth = () => {
            ...
            // Сохранение профиля
            document.getElementById('save-profile-btn-modern').addEventListener('click', () => {
                const currentUser = JSON.parse(localStorage.getItem('currentUser'));
                if (currentUser) {
                    const users = JSON.parse(localStorage.getItem('users'));
                    ...
                    if (userIndex !== -1) {
                        users[userIndex].bio = document.getElementById('user-bio')?.value || '';
                        users[userIndex].onlineStatus = document.querySelector('input[name="status"]:checked')?.value || 'online';
            ...
            // УЛУЧШЕННАЯ ФУНКЦИОНАЛЬНОСТЬ: Загрузка аватарки (центрированная)
            const setupAvatarUpload = () => {
                const uploadArea = document.getElementById('avatar-upload-area-center');
                const fileInput = document.getElementById('avatar-upload-input-center');
                const preview = document.getElementById('avatar-preview-center');
                const avatarEdit = document.querySelector('.avatar-upload-center .avatar-edit');
                ...
                uploadArea.addEventListener('dragover', (e) => {
                    ...
                    uploadArea.style.background = 'rgba(179, 103, 255, 0.2)';
                });
                
                uploadArea.addEventListener('dragleave', () => {
                    uploadArea.style.borderColor = 'var(--neon-purple)';
                    ...
                    reader.onload = function(e) {
                        ...
                        if (currentUser) {
                            ...
                            if (userIndex !== -1) {
                                ...
                                avatarElement.innerHTML = `<img src="${avatarUrl}" alt="Аватар">`;
                                updateNavigation();
        ...
        const setupChat = () => {
            ...
            document.getElementById('chat-form').addEventListener('submit', (e) => {
                ...
                if (!messageText) {
                    showNotification('Пожалуйста, введите сообщение', 'warning');
                    return;
                }
                ...
                // Индикатор набора сообщения с УМНЫМ AI
                const typingIndicator = document.createElement('div');
                typingIndicator.className = 'typing-indicator';
                typingIndicator.innerHTML = `
                    <span class="sender">st1xlox AI</span>
                    <div class="typing-dots">
                        <span>.</span><span>.</span><span>.</span>
                    </div>
                    <div class="ai-thinking">${ultraAI.getThinkingPhrase()}</div>
                `;
                document.getElementById('chat-container').appendChild(typingIndicator);
                document.getElementById('chat-container').scrollTop = document.getElementById('chat-container').scrollHeight;
                
                // Ответ УМНОГО AI через 1-3 секунды
                setTimeout(() => {
                    // Убираем индикатор набора
                    typingIndicator.remove();
                    
                    const aiResponse = ultraAI.getResponse(messageText);
                    const aiMessage = {
                        id: messages.length + 1,
                        username: "st1xlox AI",
                        text: aiResponse,
        ...
        const getOrderDetailsText = (order) => {
            ...
            switch(order.type) {
                case 'video':
                    details = `
                        <p><strong>Тип видео:</strong> ${order.data.videoType === 'promo' ? 'Промо-ролик' : order.data.videoType === 'intro' ? 'Интро/Аутро' : 'Футажи'}</p>
                ...
                case 'images':
                    details = `
                        <p><strong>Тип изображения:</strong> ${order.data.imageType === 'banner' ? 'Баннер' : order.data.imageType === 'post' ? 'Пост для соц. сетей' : 'Пикчи'}</p>
